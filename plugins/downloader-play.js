...
image: { url: yt_play[0].thumbnail }, caption: texto1, contextInfo: { externalAdReply: { title: '♡  ͜ ۬︵࣪᷼⏜݊᷼𝘿𝙚𝙨𝙘𝙖𝙧𝙜𝙖𝙨⏜࣪᷼︵۬ ͜ ', body: '<(✿◠‿◠)> 𝐓𝐞𝐜𝐧𝐨-𝐁𝐨𝐭🔱', sourceUrl: channel, thumbnail: imagen2 }}, quoted: estilo});
try {
await m.react(rwait);
