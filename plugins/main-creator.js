...
let name = await conn.getName(who)
  ...
  await sendContactArray(conn, m.chat, [
     [`${nomorown}`, `👑 Propietario`, `✨ 𝑫𝒆𝒚𝒍𝒊𝒏`, dev, 'baquedanodeyli38@gmail.com', `🇭🇳 Honduras`, `https://github.com/Deylinel/TECNO-BOT-OFICIAL`, bio],
[`${conn.user.jid.split('@')[0]}`, `Es Un Bot 🌟`, `${packname}`, `📵 No Hacer Spam`, 'moisesmusic04@gmail.com', `🇭🇳 Honduras`, `https://github.com/Deylinel/TECNO-BOT-OFICIAL`, biobot]
], m)
  } 
