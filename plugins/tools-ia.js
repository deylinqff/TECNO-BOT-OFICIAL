...
let handler = async (m, { conn, usedPrefix, command, text }) => {
    ...
    if (isQuotedImage) {
        ...
        try {
            ...
            const buttons = [
                { buttonId: 'button1', buttonText: { displayText: 'Más Información' }, type: 1 },
                { buttonId: 'button2', buttonText: { displayText: 'Otra Imagen' }, type: 1 }
            ]

            await conn.sendMessage(m.chat, { text: description, buttons: buttons, headerType: 1 }, { quoted: m })
        ...
        try {
            ...
            const buttons = [
                { buttonId: 'button1', buttonText: { displayText: 'Más Información' }, type: 1 },
                { buttonId: 'button2', buttonText: { displayText: 'Otra Consulta' }, type: 1 }
            ]

            await conn.sendMessage(m.chat, { text: response, buttons: buttons, headerType: 1 }, { quoted: m })
