...
global.authFile = 'TecnoSession'
global.authFileJB  = 'TECNO-BOT'
...
console.log(chalk.bold.greenBright(`🚀 TECNO conectado correctamente.`))

await connectSubBots();
} catch (error) {
console.error(chalk.bold.cyanBright(`🥀 Error al iniciar TECNO-BOT: `, error))
}
})();
...
let prekey = []
let directorio = readdirSync("./TECNOSession")
...
const directories = ['./TECNOSession/', './TECNO-BOT/']
